import {
  ...
  export default function Header({ account, web3Handler }: any) {
            ...
            <div className="hidden h-full lg:flex">
              ...
              >
                ...
                {account ? (
                  ...
                  <span onClick={web3Handler}>Connect Wallet</span> // Use a span for inline content
                )}
              </button>
              <button
                className={clsx(
              ...
              >
                <Link to='/dashboard'><UserCircleIcon className="h-6 w-6 stroke-2" /></Link>
              </button>
            </div>
            <button
              className={clsx(
